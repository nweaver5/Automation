...
const CADSO_MENU_SELECTOR = `${CADSO_NAV_HEADER}.querySelector("cadso-ui-menu").shadowRoot.querySelector("div")`;
...
const TASK_LIST_CONTAINER_SELECTORS = {
  SPRINT_TASK_LIST_CONTAINER: `${SN_CANVAS_SCREEN_LAST_OF_TYPE}.querySelector("section").querySelector("macroponent-72c0c6a9974ba510ac33f109c253af75").shadowRoot.querySelector("cadso-ui-list").shadowRoot`,
  PROJECT_TASK_LIST_CONTAINER: `${SN_CANVAS_SCREEN_LAST_OF_TYPE}.querySelector("section").querySelector("macroponent-d32c90d947b42510a1052a02e26d431c").shadowRoot.querySelector("cadso-ui-list").shadowRoot`,
  CAMPAIGN_TASK_LIST_CONTAINER: `${SN_CANVAS_SCREEN_LAST_OF_TYPE}.querySelector("section").querySelector("macroponent-8a6f50dd47b42510a1052a02e26d438e").shadowRoot.querySelector("cadso-ui-list").shadowRoot`,
}
