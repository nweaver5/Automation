...
outputFile = ("MemberDemo\\member_demosite_errors.log")
output = open(outputFile, 'w', encoding='utf-8')
sys.stdout = output

userProfile = os.environ['USERPROFILE']
path = os.path.dirname(userProfile + '\\Desktop\\Demosite Automation\\MemberDemo\\ChromeLogs\\')
...
path = os.path.dirname(userProfile + '\\Desktop\\Demosite Automation\\MemberDemo\\FirefoxLogs\\')
listing = os.listdir(path)
...
path = os.path.dirname(userProfile + '\\Desktop\\Demosite Automation\\MemberDemo\\IntexplorerLogs\\')
listing = os.listdir(path)
...
path = os.path.dirname(userProfile + '\\Desktop\\Demosite Automation\\MemberDemo\\BStackLogs\\')
listing = os.listdir(path)
...
path = os.path.dirname(userProfile + '\\Desktop\\Demosite Automation\\MemberDemo\\SafariLogs\\')
listing = os.listdir(path)
