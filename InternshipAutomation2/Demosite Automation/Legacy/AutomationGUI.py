...
def setMember():
    ...
    browserSelect.configure(state='active')
...
def setApi():
    ...
    browserSelect.configure(state='disabled')
    app.update_idletasks()
...
def runScripts():
    ...
    if siteChoice == 2:
        if browserChoice == 1:
            ...
            statusUpdate.set("Safari Not Supported for Provider Demo")
        else:
            statusUpdate.set("No Browser Selected")
    ...
    if siteChoice == 4:
        if serverChoice == 1:
            statusUpdate.set("Running V2 Check Test on Server 1 for Chrome")
            os.system('V2Check\\v2check_automation_chrome_v1-1.py')
        elif serverChoice == 2:
            statusUpdate.set("Running V2 Check Test on Server 2 for Chrome")
            os.system('V2Check\\v2check_automation_chrome_v1-2.py')
        elif serverChoice == 3:
            statusUpdate.set("Running V2 Check Test on Server 3 for Chrome")
            os.system('V2Check\\v2check_automation_chrome_v1-3.py')
        elif serverChoice == 4:
            statusUpdate.set("Running V2 Check Test on Server 4 for Chrome")
            os.system('V2Check\\v2check_automation_chrome_v1-4.py')
        elif serverChoice == 5:
            statusUpdate.set("Running V2 Check Test on Server 5 for Chrome")
            os.system('V2Check\\v2check_automation_chrome_v1-5.py')
        elif serverChoice == 6:
            statusUpdate.set("Running V2 Check Test on Server 6 for Chrome")
            os.system('V2Check\\v2check_automation_chrome_v1-6.py')
        elif serverChoice == 7:
            statusUpdate.set("Running V2 Check Test on Server 7 for Chrome")
            os.system('V2Check\\v2check_automation_chrome_v1-7.py')
        elif batchChoice == 1:
            statusUpdate.set("Running V2 Check Test Batch for Servers 1-3 for Chrome")
            os.system('V2Check\\v2check_automation_chrome_run_1-3.bat')
        elif batchChoice == 2:
            statusUpdate.set("Running V2 Check Test Batch for Servers 4-7 for Chrome")
            os.system('V2Check\\v2check_automation_chrome_run_4-7.bat')
        elif batchChoice == 3:
            statusUpdate.set("Running V2 Check Test Batch for All Servers for Chrome")
            os.system('V2Check\\v2check_automation_chrome_run_all.bat')
        else:
            statusUpdate.set("No Server/Batch Selected")

def seleniumInstall():
    os.system('Tools\\SeleniumInstall.bat')

def tutorialLink():
    os.system('Tools\\open_tutorial.py')
	
def threadTest():
    _thread.start_new_thread(runScripts, ())

def checkErrors():
    siteChoiceCheck = site.get()
    if siteChoiceCheck == 1:
        statusUpdate.set("Checking Errors for Member Demo")
        os.system('MemberDemo\\failcheck.py')

        text.delete('1.0', END)
        with open('MemberDemo\\member_demosite_errors.log') as f:
            lines = f.read().splitlines()

        for i in lines:
            text.insert(INSERT, i)
            text.insert(INSERT, '\n')
    elif siteChoiceCheck == 2:
        statusUpdate.set("Checking Errors for Provider Demo")
        os.system('ProviderDemo\\failcheck.py')
        text.delete('1.0', END)
        with open('ProviderDemo\\provider_demosite_errors.log') as f:
            lines = f.read().splitlines()

        for i in lines:
            text.insert(INSERT, i)
            text.insert(INSERT, '\n')
    elif siteChoiceCheck == 3:
        statusUpdate.set("Checking Errors for APICheck")
        os.system('APICheck\\failcheck.py')
        text.delete('1.0', END)
        with open('APICheck\\apicheck_demosite_errors.log') as f:
            lines = f.read().splitlines()

        for i in lines:
            text.insert(INSERT, i)
            text.insert(INSERT, '\n')
    elif siteChoiceCheck == 4:
        statusUpdate.set("Checking Errors for V2Check")
        os.system('V2Check\\failcheck.py')
        text.delete('1.0', END)
        with open('V2Check\\v2check_demosite_errors.log') as f:
            lines = f.read().splitlines()
        ...
        statusUpdate.set("Please Select a Site")
...
helpMenu.add_command(label="Selenium Setup", command=seleniumInstall)
helpMenu.add_command(label="Tutorial", command=tutorialLink)
...
siteSelect = Menubutton(toolbar, textvariable=selectedSite, relief=RAISED, width=30)
...
browserSelect = Menubutton(toolbar, textvariable=selectedBrowser, relief=RAISED, width=30)
...
serverSelect = Menubutton(toolbar, textvariable=selectedServer, relief=RAISED, width=30)
...
batchSelect = Menubutton(toolbar, textvariable=selectedBatch, relief=RAISED, width=30)
...
toolbar2 = Frame(app)
runTestButton = Button(toolbar2, text="Run Test", command=threadTest, width=50)
checkErrorsButton = Button(toolbar2, text="Check Errors", command=checkErrors, width = 50)
runTestButton.pack(side=LEFT, padx=2, pady=2)
checkErrorsButton.pack(side=LEFT, padx=2, pady=2)
toolbar2.pack(side=TOP, pady=5)

text = Text(app, height=25, width=150)
text.pack(side=TOP)
